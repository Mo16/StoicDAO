                ...
                return (0, t.useEffect)((function () {
                    ...
                    children: [(0, s.jsxs)("div", {
                        ...
                        children: [(0, s.jsxs)("div", {
                            ...
                            children: ["Copyright 2021 [PROJECT NAME]. ", (0, s.jsx)("button", {
                                type: "button",
                                onClick: function () {
                                    return c(!d)
                                },
                        ...
                        children: [(0, s.jsx)("div", {
                            ...
                            children: [(0, s.jsx)("button", {
                                ...
                                children: [(0, s.jsx)("p", {
                                    children: "[PROJECT NAME] is a collection of digital artworks (NFTs) running on the Solana blockchain. This website is only an interface allowing participants to exchange digital collectibles. Users are entirely responsible for the safety and management of their own private Solana wallets and validating all transactions and contracts generated by this website before approval. Furthermore, as the [PROJECT NAME] smart contract runs on the Solana blockchain, there is no ability to undo, reverse, or restore any transactions."
                                }), (0, s.jsx)("p", {
                                    children: "This website and its connected services are provided \u201cas is\u201d and \u201cas available\u201d without warranty of any kind. By using this website you are accepting sole responsibility for any and all transactions involving [PROJECT NAME] digital collectibles."
                                })]
                            }), (0, s.jsx)("h2", {
                                className: "text-26 text-red-400 mb-10",
                                children: "Ownership"
                                ...
                                children: [(0, s.jsx)("p", {
                                    children: "1) You own the NFT. Each [PROJECT NAME] is an NFT on the Solana blockchain. When you purchase an NFT, you own the underlying [PROJECT NAME], the Art, completely. Ownership of the NFT is mediated entirely by the smart contract and the Solana blockchain: at no point may we seize, freeze, or otherwise modify the ownership of any [PROJECT NAME]."
                                }), (0, s.jsxs)("p", {
                                    children: ["2) ", (0, s.jsx)("strong", {
                                        children: "Personal Use"
                                    }), ". Subject to your continued compliance with these Terms, [PROJECT NAME] grants you a worldwide, royalty-free license to use, copy, and display the purchased art, along with any extensions that you choose to create or use, solely for the following purposes: (i) for your own personal, non-commercial use; (ii) as part of a marketplace that permits the purchase and sale of your [PROJECT NAME] NFT, provided that the marketplace cryptographically verifies each [PROJECT NAME] owner\u2019s rights to display the art for their [PROJECT NAME] to ensure that only the actual owner can display the art; or (iii) as part of a third party website or application that permits the inclusion, involvement, or participation of your [PROJECT NAME], provided that the website/application cryptographically verifies each [PROJECT NAME] owner\u2019s rights to display the art for their [PROJECT NAME] to ensure that only the actual owner can display the art, and provided that the art is no longer visible once the owner of the [PROJECT NAME] leaves the website/application."]
                                }), (0, s.jsxs)("p", {
                                    children: ["3) ", (0, s.jsx)("strong", {
                                        children: "Commercial Use"
                                    }), ". Subject to your continued compliance with these Terms, [PROJECT NAME] grants you an unlimited, worldwide license to use, copy, and display the purchased art for the purpose of creating derivative works based upon the art (\u201ccommercial use\u201d). Examples of such commercial use would e.g. be the use of the art to produce and sell merchandise products such as shirts, socks, mugs, stickers, etc displaying copies of the art. For the sake of clarity, nothing in this section will be deemed to restrict you from (i) owning or operating a marketplace that permits the use and sale of [PROJECT NAME PLURAL] generally, provided that the marketplace cryptographically verifies each [PROJECT NAME] owner\u2019s rights to display the art for their [PROJECT NAME] to ensure that only the actual owner can display the art; (ii) owning or operating a third party website or application that permits the inclusion, involvement, or participation of [PROJECT NAME PLURAL] generally, provided that the third party website or application cryptographically verifies each [PROJECT NAME] owner\u2019s rights to display the art for their [PROJECT NAME] to ensure that only the actual owner can display the art, and provided that the art is no longer visible once the owner of the purchased [PROJECT NAME] leaves the website/application; or (iii) earning revenue from any of the foregoing."]
                                })]
                            })]
                        })]
                    })]
                        ...
                        children: (0, l.jsx)("nav", {
                            ...
                            children: (0, l.jsxs)("ul", {
                                ...
                                children: [(0, l.jsx)("li", {
                                    ...
                                    className: "mr-30",
                                    children: (0, l.jsxs)("a", {
                                        href: "https://members.redpandasquad.com/",
                                        target: "_blank",
                                        className: "flex",
                                        children: ["Members Only", (0, l.jsx)("svg", {
                                            xmlns: "http://www.w3.org/2000/svg",
                                            className: "h-[2.25rem] w-[2.25rem] transform rotate-45",
                                            viewBox: "0 0 20 20",
                                            fill: "currentColor",
